		...
		try {
			while (true) {
				...
				if (packet.startsWith("200")) {
					...
					JOptionPane.showMessageDialog(interfaz, packet.substring(4), "Desconectado",
			...
			JOptionPane.showMessageDialog(interfaz, "Se ha perdido la conexion con el servidor", "Desconectado",
					JOptionPane.ERROR_MESSAGE);
			System.exit(0);
		}
	}
...
//						Log.log("timeuser " + System.currentTimeMillis());
